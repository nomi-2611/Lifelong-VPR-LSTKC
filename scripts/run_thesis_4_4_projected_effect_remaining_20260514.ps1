...
# Baseline already completed on 2026-05-13:
# logs\thesis_44_projected_effect_1_baseline_20260513

# 2. Short-term transfer: adjacent-stage relation + self teacher similarity.
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_2_short_20260514" -ExtraArgs @(
    "--AF_weight", "1.0",
...
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_3_long_20260514" -ExtraArgs @(
    "--AF_weight", "0.0",
...
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_4_short_long_20260514" -ExtraArgs @(
    "--AF_weight", "1.0",
    "--place-teacher-sim-weight", "0.5",
    "--place-teacher-sim-self",
    "--place-teacher-sim-limit", "0",
