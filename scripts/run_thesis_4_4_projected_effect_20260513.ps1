...
# 1. Plain sequential training: no anti-forgetting, no memory, no fusion.
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_1_baseline_20260513" -ExtraArgs @(
    "--AF_weight", "0.0",
    "--place-teacher-sim-weight", "0.0",
    "--place-raw-distill-weight", "0.0",
    "--place-projected-distill-weight", "0.0",
    "--place-raw-memory-size", "0"
)

# 2. Short-term transfer: adjacent-stage relation + self teacher similarity.
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_2_short_20260513" -ExtraArgs @(
    "--AF_weight", "1.0",
...
# 3. Long-term retention: projected descriptor distillation on previous-stage memory.
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_3_long_20260513" -ExtraArgs @(
    "--AF_weight", "0.0",
    "--place-teacher-sim-weight", "0.0",
    "--place-raw-distill-weight", "0.0",
...
# 4. Short + long consolidation.
Invoke-PlaceRun -LogsDir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\thesis_44_projected_effect_4_short_long_20260513" -ExtraArgs @(
    "--AF_weight", "1.0",
    "--place-teacher-sim-weight", "0.5",
    "--place-teacher-sim-self",
    "--place-teacher-sim-limit", "0",
