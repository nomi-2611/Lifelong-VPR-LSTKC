@echo off
set TRAIN_DIR=C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\formal_vprtempo_snn_3stage_raw05_stageadapt_bg4
set EVAL_DIR=C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\formal_vprtempo_snn_3stage_raw05_stageadapt_bg4_eval
...
if not exist "%TRAIN_DIR%\tart_place_checkpoint.pth.tar" goto wait_more
goto run_eval
