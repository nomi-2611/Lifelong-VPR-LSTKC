...
python continual_train.py ^
  ...
  --logs-dir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\formal_vprtempo_snn_3stage_resumeable_v1" ^
  --task-type place ^
  ...
  --vprtempo-stage-output-dir "C:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\formal_vprtempo_stage_adapt_resumeable_v1" ^
