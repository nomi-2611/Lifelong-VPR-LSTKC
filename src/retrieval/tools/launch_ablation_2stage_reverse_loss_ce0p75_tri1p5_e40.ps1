$runDir = "c:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\abl2_reverse_loss_ce0p75_tri1p5_e40_offline_20260508"
...
$args = @(
  ...
  "--place-ce-weight", "0.75",
  "--place-triplet-weight", "1.5",
