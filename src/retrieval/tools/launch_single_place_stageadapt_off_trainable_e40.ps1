param(
  [string]$Dataset = "nordland_place",
  [string]$RunName = "single_nordland_stageadapt_off_trainable_e40_offline_20260508"
)

$runDir = "c:\Users\86189\Desktop\code\AAAI2024-LSTKC\logs\$RunName"
...
Write-Output ("PID={0} DATASET={1} RUN={2}" -f $proc.Id, $Dataset, $RunName)
