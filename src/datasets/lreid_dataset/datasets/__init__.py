...
from .place_recognition import (
    IncrementalSamples4nordlandPlace,
    IncrementalSamples4robotcarPlace,
    IncrementalSamples4tartPlace,
    IncrementalSamples4mslsPlace,
    IncrementalSamples4pitts30kPlace,
)
...
__factory = {
    ...
    'nordland_place': IncrementalSamples4nordlandPlace,
    'robotcar_place': IncrementalSamples4robotcarPlace,
    'tart_place': IncrementalSamples4tartPlace,
    'msls_place': IncrementalSamples4mslsPlace,
    'pitts30k_place': IncrementalSamples4pitts30kPlace,
